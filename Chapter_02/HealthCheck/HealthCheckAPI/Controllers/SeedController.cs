...
namespace HealthCheckAPI.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public SeedController(
            ...
            IWebHostEnvironment env, RoleManager<IdentityRole> roleManager, UserManager<ApplicationUser> userManager, IConfiguration configuration)
        {
            _context = context;
            _env = env;
